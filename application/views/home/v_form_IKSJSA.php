                ...
                <div class="row setup-content" id="step-1">
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <label class="control-label">Nama Direktur / Koordinator Subcont</label><font color="red">*</font>
                                <input type="text" name="direktur_koordinat" class="form-control" id="direktur_koordinat" for="direktur_koordinat" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nama PIC Subcont</label><font color="red">*</font>
                                <input type="text" name="pic_subcont" class="form-control" id="pic_subcont" for="pic_subcont" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nomor Handphone PIC Subcont</label><font color="red">*</font>
                                <input type="number" name="nohp_subcont" class="form-control col-sm-6" id="nohp_subcont" for="nohp_subcont" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Jumlah PIC Subcont yang akan Bekerja</label><font color="red">*</font>
                            ...
                            <div class="form-group" id="namamp-section">
                                <!-- <label class="control-label">Nama Pekerja (MP Subcont)</label><font color="red">*</font>
                            ...
                            <div class="form-group">
                                <label class="control-label">Nama PIC PT CBI</label><font color="red">*</font>
                                <input type="text" name="pic_cbi" class="form-control" id="pic_cbi" for="pic_cbi" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Seksie PIC PT CBI</label><font color="red">*</font>
                                <input type="text" name="sie_pic_cbi" class="form-control col-sm-4" id="sie_pic_cbi" for="sie_pic_cbi" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nomor Handphone PIC PT CBI</label><font color="red">*</font>
                                <input type="number" name="nohp_cbi" class="form-control col-sm-6" id="nohp_cbi" for="nohp_cbi" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Peralatan Kerja yang Dibawa</label><font color="red">*</font>
                            ...
                            <div class="form-group">
                                <label class="control-label">APD Tambahan</label><font color="red">*</font>
                                <div class="form-group clearfix">
                                    <div class="form-check">
                            ...
                            <div class="form-group">
                                <label class="control-label">Jenis Pekerjaan</label><font color="red">*</font>
                                <input type="text" name="jenis_pekerjaan" class="form-control col-sm-7" id="jenis_pekerjaan" for="jenis_pekerjaan"  required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Kategori Pekerjaan</label><font color="red">*</font>
                                <div class="form-group clearfix">
                                    <div class="form-check">
