        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('Dashboard/konfirm_gambar');?>">Data Subcont</a>
                        <!-- <a class="collapse-item" href="<?php echo base_url('Dashboard/dashboardJSA_PIC');?>">Data JSA</a> -->
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?php echo base_url('Dashboard/dataAktif');?>">Data Subcont Aktif</a>
                        <a class="collapse-item" href="<?php echo base_url('Dashboard/konfirm_form');?>">Data All Subcont</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <!-- <h6 class="collapse-header">Custom Utilities:</h6> -->
                        <a class="collapse-item" href="<?php echo base_url('Dashboard/konfirm_subcont');?>">Data Subcont</a>
                        <!-- <a class="collapse-item" href="<?php echo base_url('Dashboard/dashboardJSA_EHS');?>">Data JSA</a> -->
                    </div>
                </div>
            </li>
            <?php } ?>
            ...
            <!-- <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="<?php echo base_url('assets/sbadmin/')?>img/undraw_rocket.svg" alt="...">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo 'Hallo - ' . $this->session->userdata('username')?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?php echo base_url('assets/sbadmin/')?>img/logok3hijau.png">
                            </a>
